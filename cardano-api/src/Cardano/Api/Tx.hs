...
instance Show (Tx era) where
    ...
    showsPrec p (ShelleyTx ShelleyBasedEraVoltairePrototypeOne tx) =
      showParen (p >= 11) $
        showString "ShelleyTx ShelleyBasedEraVoltairePrototypeOne "
      . showsPrec 11 tx

    showsPrec p (ShelleyTx ShelleyBasedEraVoltairePrototypeTwo tx) =
      showParen (p >= 11) $
        showString "ShelleyTx ShelleyBasedEraVoltairePrototypeTwo "
      . showsPrec 11 tx
      ...
      case cardanoEra :: CardanoEra era of
        ...
        VoltairePrototypeOneEra
                   -> deserialiseShelleyBasedTx
                        (ShelleyTx ShelleyBasedEraVoltairePrototypeOne) bs
        VoltairePrototypeTwoEra
                   -> deserialiseShelleyBasedTx
                        (ShelleyTx ShelleyBasedEraVoltairePrototypeTwo) bs
...
instance Eq (KeyWitness era) where
    ...
    (==) (ShelleyBootstrapWitness era wA)
      ...
      case era of
        ...
        ShelleyBasedEraVoltairePrototypeOne -> wA == wB
        ShelleyBasedEraVoltairePrototypeTwo -> wA == wB
...
instance Show (KeyWitness era) where
    ...
    showsPrec p (ShelleyBootstrapWitness ShelleyBasedEraVoltairePrototypeOne tx) =
      showParen (p >= 11) $
        showString "ShelleyBootstrapWitness ShelleyBasedEraVoltairePrototypeOne "
      . showsPrec 11 tx

    showsPrec p (ShelleyBootstrapWitness ShelleyBasedEraVoltairePrototypeTwo tx) =
      showParen (p >= 11) $
        showString "ShelleyBootstrapWitness ShelleyBasedEraVoltairePrototypeTwo "
      . showsPrec 11 tx
    ...
    showsPrec p (ShelleyKeyWitness ShelleyBasedEraVoltairePrototypeOne tx) =
      showParen (p >= 11) $
        showString "ShelleyKeyWitness ShelleyBasedEraVoltairePrototypeOne "
      . showsPrec 11 tx

    showsPrec p (ShelleyKeyWitness ShelleyBasedEraVoltairePrototypeTwo tx) =
      showParen (p >= 11) $
        showString "ShelleyKeyWitness ShelleyBasedEraVoltairePrototypeTwo "
      . showsPrec 11 tx
...
instance IsCardanoEra era => SerialiseAsCBOR (KeyWitness era) where
    ...
    serialiseToCBOR (ShelleyKeyWitness era wit) =
      ...
      case era of
        ...
        ShelleyBasedEraVoltairePrototypeOne -> encodeShelleyBasedKeyWitness wit
        ShelleyBasedEraVoltairePrototypeTwo -> encodeShelleyBasedKeyWitness wit
    ...
    serialiseToCBOR (ShelleyBootstrapWitness era wit) =
      ...
      case era of
        ...
        ShelleyBasedEraVoltairePrototypeOne -> encodeShelleyBasedBootstrapWitness wit
        ShelleyBasedEraVoltairePrototypeTwo -> encodeShelleyBasedBootstrapWitness wit
    ...
    deserialiseFromCBOR _ bs =
      case cardanoEra :: CardanoEra era of
        ...
        VoltairePrototypeOneEra -> decodeShelleyBasedWitness ShelleyBasedEraVoltairePrototypeOne bs
        VoltairePrototypeTwoEra -> decodeShelleyBasedWitness ShelleyBasedEraVoltairePrototypeTwo bs
...
instance IsCardanoEra era => HasTextEnvelope (KeyWitness era) where
    textEnvelopeType _ =
      case cardanoEra :: CardanoEra era of
        ...
        VoltairePrototypeTwoEra -> "TxWitness VoltairePrototypeTwoEra"
...
getTxBody (ShelleyTx era tx) =
    case era of
      ...
      ShelleyBasedEraVoltairePrototypeOne -> getShelleyTxBody tx
      ShelleyBasedEraVoltairePrototypeTwo -> getShelleyTxBody tx
  where
...
getTxWitnesses (ShelleyTx era tx) =
    case era of
      ...
      ShelleyBasedEraVoltairePrototypeOne -> getShelleyTxWitnesses tx
      ShelleyBasedEraVoltairePrototypeTwo -> getShelleyTxWitnesses tx
  where
...
makeSignedTransaction witnesses (ShelleyTxBody era txbody txscripts txmetadata) =
    case era of
      ...
      ShelleyBasedEraVoltairePrototypeOne -> makeShelleySignedTransaction txbody
      ShelleyBasedEraVoltairePrototypeTwo -> makeShelleySignedTransaction txbody
  where
...
makeShelleyKeyWitness (ShelleyTxBody era txbody _ _) =
    case era of
      ...
      ShelleyBasedEraVoltairePrototypeOne -> makeShelleyBasedKeyWitness txbody
      ShelleyBasedEraVoltairePrototypeTwo -> makeShelleyBasedKeyWitness txbody
  where
